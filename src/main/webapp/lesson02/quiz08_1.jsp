...
<%
	...
	Map<String, Object> target = new HashMap<>(); // {} 아직 비어있음
	...
	// out.print(target); item에 들어 있는 값이 target에 잘 들어갔는지 확인
%>
	<div class="container">
	<%-- <%
		...
		for (Map <String, Object> target : list) {
			if (id == (Integer)target.get("id")) {
	%> --%>
		<div class="d-flex">
			<img alt="표지" src="<%= target.get("image") %>" class="w-25">
			<div>
