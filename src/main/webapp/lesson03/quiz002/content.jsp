...
<section>
	<div>
		<div class="info d-flex">
			<img src="<%=artistInfo.get("photo")%>" alt="photo" width="150px"
				class="m-3">
			<div class="m-3">
				<h2 class="name"><%=artistInfo.get("name")%></h2>
				<div class="agency"><%=artistInfo.get("agency")%></div>
				<div class="debute"><%=artistInfo.get("debute")%>데뷔
				</div>
			</div>
		</div>
		...
		<table class="table text-center">
			...
			<tbody>
				...
				<tr>
					<td><%=list.get("id")%></td>
					<td><a href="info_template.jsp"><%=list.get("title")%></td>
